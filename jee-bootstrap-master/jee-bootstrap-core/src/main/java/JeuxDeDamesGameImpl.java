	    			...
	    			{	
	    				...
	    				else
	    				{
	    					switch(checkboard[ligneFinal][columnFinal])
	    					{
	    						...
	    						{
	    							if(checkboard[ligneFinal+2][columnFinal-2]==PawnColor.BLACK && checkboard[ligneFinal+3][columnFinal-3]==null )
	    							{
	    							...
	    							{
	    								if(checkboard[ligneFinal][columnFinal-2]==PawnColor.BLACK && checkboard[ligneFinal-1][columnFinal-3]==null)
	    								{
	    						...
	    						else 
	    						{
	    							if(ligneFinal==ligneInitial-1 && columnFinal==columnInitial-1 && checkboard[ligneFinal-1][columnFinal-1]==null )
	    							{
	    								...
	    								{
	    									if(checkboard[ligneFinal][columnFinal-2]==PawnColor.BLACK && checkboard[ligneInitial][columnFinal-3]==null)
	    									{
	    										checkboard[ligneFinal+1][columnFinal-3]=checkboard[ligneInitial][columnInitial];
	    										checkboard[ligneFinal][columnFinal]=null;
	    										checkboard[ligneFinal][columnFinal-2]=null;
	    					...
	    					else
	    					{
	    						switch(checkboard[ligneFinal][columnFinal])
	    						{
	    							...
	    							case WHITE:
	    								if(ligneFinal==ligneInitial+1 && columnFinal==columnInitial+1 && checkboard[ligneFinal+1][columnFinal+1]==null )
	    								{
	    									if(checkboard[ligneFinal+2][columnFinal+2]==PawnColor.WHITE && checkboard[ligneFinal+3][columnFinal+3]==null )
	    									{
	    										checkboard[ligneFinal+3][columnFinal+3]=checkboard[ligneInitial][columnInitial];
	    										checkboard[ligneFinal][columnFinal]=null;
	    										checkboard[ligneFinal+2][columnFinal+2]=null;
	    									...
	    									{
	    										if(checkboard[ligneFinal][columnFinal+2]==PawnColor.WHITE && checkboard[ligneFinal-1][columnFinal+3]==null)
	    										{
	    											checkboard[ligneFinal-1][columnFinal+3]=checkboard[ligneInitial][columnInitial];
	    											checkboard[ligneFinal][columnFinal]=null;
	    											checkboard[ligneFinal][columnFinal+2]=null;
	    								...
	    								if(ligneFinal==ligneInitial-1 && columnFinal==columnInitial+1 && checkboard[ligneFinal-1][columnFinal+1]==null )
	    								{
	    									...
	    									{
	    										if(checkboard[ligneFinal][columnFinal+2]==PawnColor.WHITE && checkboard[ligneInitial][columnFinal+3]==null)
	    										{
	    											checkboard[ligneFinal+1][columnFinal+3]=checkboard[ligneInitial][columnInitial];
	    											checkboard[ligneFinal][columnFinal]=null;
	    											checkboard[ligneFinal][columnFinal+2]=null;
